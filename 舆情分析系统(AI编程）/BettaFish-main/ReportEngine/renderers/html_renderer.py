...
<header class="report-header no-print">
  ...
  <div class="header-actions">
    <button id="export-btn" class="action-btn embedded-hide" type="button" style="display: none;">⬇️ 导出PDF</button>
  </div>
</header>
""".strip()
...
.dark-mode {{ /* 含义：暗色主题变量区域；设置：在本块内调整相关属性 */
  --bg-color: transparent; /* 含义：页面背景色主色调；设置：在 themeTokens 中覆盖或改此默认值 */
  --text-color: #EBEBF5; /* 含义：正文文本基础颜色；设置：在 themeTokens 中覆盖或改此默认值 */
  ...
  --secondary-color: #6ea8fe; /* 含义：次级色（提示/标签）；设置：在 themeTokens 中覆盖或改此默认值 */
  --secondary-color-light: #91caff; /* 含义：次级色浅色；设置：在 themeTokens 中覆盖或改此默认值 */
  --secondary-color-dark: #1f6feb; /* 含义：次级色深色；设置：在 themeTokens 中覆盖或改此默认值 */
  --card-bg: rgba(255,255,255,0.04); /* 含义：卡片/容器背景色；设置：在 themeTokens 中覆盖或改此默认值 */
  --border-color: rgba(255,255,255,0.08); /* 含义：常规边框色；设置：在 themeTokens 中覆盖或改此默认值 */
...
/* 嵌入 iframe 时隐藏操作按钮（由外层 FAB 接管） */
.embedded-hide {{ display: none !important; }}
/* 独立打开时（非 iframe）恢复显示 */
@media all {{
  body.standalone-report .embedded-hide {{ display: inline-flex !important; }}
}}
...
body {{ /* 含义：全局排版与背景设置；设置：在本块内调整相关属性 */
  ...
  font-family: -apple-system, 'SF Pro Display', 'PingFang SC', 'Helvetica Neue', sans-serif; /* 含义：字体族；设置：按需调整数值/颜色/变量 */
  background: transparent !important; /* 含义：背景色或渐变效果；设置：按需调整数值/颜色/变量 */
  color: #EBEBF5; /* 含义：文字颜色；设置：按需调整数值/颜色/变量 */
...
h1, h2, h3, h4, h5, h6 {{ color: #FFFFFF !important; font-family: -apple-system, 'SF Pro Display', 'PingFang SC', 'Helvetica Neue', sans-serif; }}
...
.report-header {{ /* 含义：页眉吸顶区域；设置：在本块内调整相关属性 */
  ...
  background: rgba(10,10,20,0.6); /* 含义：背景色或渐变效果；设置：按需调整数值/颜色/变量 */
  backdrop-filter: blur(16px); /* 含义：背景模糊；设置：按需调整数值/颜色/变量 */
  -webkit-backdrop-filter: blur(16px); /* 含义：背景模糊；设置：按需调整数值/颜色/变量 */
  padding: 20px; /* 含义：内边距，控制内容与容器边缘的距离；设置：按需调整数值/颜色/变量 */
  border-bottom: 1px solid rgba(255,255,255,0.06); /* 含义：底部边框；设置：按需调整数值/颜色/变量 */
...
.hero-section {{ /* 含义：封面摘要主容器；设置：在本块内调整相关属性 */
  ...
  background: linear-gradient(135deg, rgba(110,168,254,0.08), rgba(110,168,254,0.03)); /* 含义：背景色或渐变效果；设置：按需调整数值/颜色/变量 */
  border: 1px solid rgba(255,255,255,0.06); /* 含义：边框样式；设置：按需调整数值/颜色/变量 */
...
.report-header h1 {{ /* 含义：页眉主标题；设置：在本块内调整相关属性 */
  ...
  color: #FFFFFF; /* 含义：文字颜色；设置：按需调整数值/颜色/变量 */
}} /* 结束 .report-header h1 */
